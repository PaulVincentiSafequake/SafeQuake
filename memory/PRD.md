...
6. **In-progress: Production migration** (post Emergent Support reply) — 7 migration-prep artifacts landed 2026-08-06:
   ...
   - **Blocked on** Emergent Support reply. Support email SENT by Paul on 2026-08-06; awaiting reply. Execution is human-driven (Fly.io + Atlas provisioning + DNS cutover), not agent-driven.
...
9. Next backlog: dual casualty reports (B1/B2), dashboard category filter, Crockford Base32 rescue codes + QR + `/r/?code=`, `server.py` refactor into route modules.
