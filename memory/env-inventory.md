...
| `ADMIN_TRIGGER_PASSWORD` | `m11vRwfDoxnHvIMLkKzjUwQy` currently | **KEEP SAME VALUE** during migration | Same reasoning as JWT_SECRET. This is the X-Admin-Token for legacy admin routes; changing breaks the dashboard mid-migration. Rotate post-migration once dashboard has re-verified. |
