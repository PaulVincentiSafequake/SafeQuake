...
const OPTIONS: {
...
}[] = [
  {
    answer: "same",
    label: "No change",
    helper: "The same as when I last told you",
    bg: "#2B3A55", fg: "#FFFFFF",
  },
  {
    answer: "worse",
...
const styles = StyleSheet.create({
  ...
  btnLabel: { fontSize: 20, fontWeight: "900" },
  btnHelper: { fontSize: 14, opacity: 0.9, marginTop: 2 },
  pending: { color: "#F4C842", fontSize: 14, lineHeight: 19, marginTop: 8 },
  footer: { color: "#8FA0BC", fontSize: 14, lineHeight: 19, marginTop: 18 },
